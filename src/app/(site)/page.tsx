  ...
  return (
    <>
      <section className="mt-10 gap-4 overflow-hidden px-4 sm:flex sm:flex-col sm:px-6 md:items-center md:justify-center">
        ...
        />
        <div className="mt-[6px] rounded-xl bg-white bg-gradient-to-r from-primary to-brand-primaryBlue p-[2px] sm:w-[300px]">
          <Button
            variant="btn-secondary"
            className="w-full rounded-[10px] bg-background p-6 text-2xl"
          >
            Get Next Notion free
          </Button>
        </div>
      ...
      <section className="relative">
        <div className="after:content[''] before:content[''] acfter:from-background flex overflow-hidden before:absolute before:bottom-0 before:left-0 before:top-0 before:z-10 before:w-20 before:bg-gradient-to-r before:from-background before:to-transparent after:absolute after:bottom-0 after:right-0 after:top-0 after:z-10 after:w-20 after:bg-gradient-to-l after:to-transparent before:dark:from-brand-dark after:dark:from-brand-dark">
          {[...Array(2)].map((arr) => (
      ...
      <section className="relative flex flex-col items-center justify-center px-4 sm:px-6">
        ...
        <div className="relative mt-10 flex max-w-[450px] items-center justify-center rounded-2xl border-8 border-washed-purple-300 border-opacity-10 sm:ml-0">
          <Image src={Cal} alt="banner image" className="rounded-2xl" />
        </div>
      </section>
      <section className="relative">
        <div className="absolute top-56 -z-10 h-32 w-[30%] rounded-full bg-brand-primaryPurple/50 blur-[120px]" />
        ...
        <div className="mt-10 flex flex-col-reverse items-center justify-center gap-4 sm:flex-row sm:items-stretch">
          {PRICING_CARDS.map((card) => (
            <CustomCard
              key={card.planType}
              className={clsx(
                "background-blur-3xl relative w-[350px] rounded-2xl dark:bg-black/60",
                {
